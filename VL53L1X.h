...
static const uint8_t VL53L1X_DEFAULT_CONFIGURATION[] = {
  ...
  0x01, /* 0x72 : distance threshold high MSB (in mm, MSB+LSB), use SetD:tanceThreshold() */
...
bool vl53l1x_init(uint8_t N,uint8_t newAddress,uint8_t shdnPin);
//void vl53l1x_get_identification(uint8_t N);
...
//void vl53l1x_setScaling(uint8_t N, uint8_t new_scaling);
